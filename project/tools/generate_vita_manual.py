...
def save_pages(outdir: Path):
    ...
    y+=18
    logs=[("Launcher", "ux0:data/FEARVita/fear_launcher.log"),
    ...
    for name,path in logs:
        ...
        y+=48
    y+=8
    y=paragraph(d, "Bei einem Crash zusätzlich den neuen Core-Dump sichern. Ein Log direkt nach dem Fehler ist am wertvollsten.", y, 18)
    im.save(outdir/'004.png', optimize=True)

    im,d = base_page(5, "Steuerung · Standardprofil")
    # Two columns to fit every binding.
    left=[
